 ...
 * </ul>
 *
 * @see org.eclipse.gmt.modisco.java.emffrag.metadata.JavaPackage#getCatchClause()
 * @model
 * @generated
 */
public interface CatchClause extends Statement {
	 ...
	 * @see org.eclipse.gmt.modisco.java.emffrag.metadata.JavaPackage#getCatchClause_Exception()
	 * @see org.eclipse.gmt.modisco.java.SingleVariableDeclaration#getCatchClause
	 * @model opposite="catchClause" containment="true" resolveProxies="true" required="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see #setBody(Block)
	 * @see org.eclipse.gmt.modisco.java.emffrag.metadata.JavaPackage#getCatchClause_Body()
