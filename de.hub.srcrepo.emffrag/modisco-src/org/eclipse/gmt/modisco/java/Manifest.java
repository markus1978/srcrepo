 ...
 * </ul>
 *
 * @see org.eclipse.gmt.modisco.java.emffrag.metadata.JavaPackage#getManifest()
 * @model
 * @extends FObject
 * @generated
 */
public interface Manifest extends FObject {
	/**
	 ...
	 * @see org.eclipse.gmt.modisco.java.emffrag.metadata.JavaPackage#getManifest_MainAttributes()
	 ...
	 * @see org.eclipse.gmt.modisco.java.emffrag.metadata.JavaPackage#getManifest_EntryAttributes()
	 * @model containment="true" resolveProxies="true" ordered="false"
	 * @generated
	 */
