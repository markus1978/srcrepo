 ...
 * </ul>
 *
 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getJavaCompilationUnitRef()
 * @model
 * @generated
 */
public interface JavaCompilationUnitRef extends AbstractFileRef {
	 ...
	 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getJavaCompilationUnitRef_CompilationUnitModel()
