 ...
 *   <li>{@link de.hub.srcrepo.repositorymodel.Rev#getImportErrors <em>Import Errors</em>}</li>
 * </ul>
 *
 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getRev()
 * @model
 * @generated
 */
public interface Rev extends EObject {
	 ...
	 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getRev_Author()
	 * @model
	 * @generated
	 */
	String getAuthor();
	 ...
	 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getRev_Commiter()
	 * @model
	 * @generated
	 */
	String getCommiter();
	 ...
	 * @see #setName(String)
	 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getRev_Name()
	 * @model
	 * @generated
	 */
	String getName();
	 ...
	 * @see #setTime(Date)
	 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getRev_Time()
	 * @model
	 * @generated
	 */
	Date getTime();
	 ...
	 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getRev_Message()
	 * @model
	 * @generated
	 */
	String getMessage();
	 ...
	 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getRev_ParentRelations()
	 ...
	 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getRev_ChildRelations()
	...
	/**
	 * Returns the value of the '<em><b>Import Errors</b></em>' containment reference list.
	 * The list contents are of type {@link de.hub.srcrepo.repositorymodel.ImportError}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Import Errors</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Import Errors</em>' containment reference list.
	 * @see de.hub.srcrepo.repositorymodel.emffrag.metadata.RepositoryModelPackage#getRev_ImportErrors()
	 * @model containment="true" resolveProxies="true"
	 * @generated
	 */
	EList<ImportError> getImportErrors();
