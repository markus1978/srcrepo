...
public class ExtensionsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExtensionsSwitch<Adapter> modelSwitch =
		new ExtensionsSwitch<Adapter>() {
			@Override
			public Adapter caseImportLog(ImportLog object) {
				return createImportLogAdapter();
			}
			@Override
			public Adapter caseImportLogEntry(ImportLogEntry object) {
				return createImportLogEntryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hub.srcrepo.emffrag.extensions.ImportLog <em>Import Log</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createImportLogAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.hub.srcrepo.emffrag.extensions.ImportLogEntry <em>Import Log Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createImportLogEntryAdapter() {
		return null;
	}
