...
public class GitModelPackageImpl extends EPackageImpl implements GitModelPackage {
	 ...
	 * @generated
	 */
	private EClass emfFragSourceRepositoryEClass = null;
	 ...
	 * @see de.hub.srcrepo.gitmodel.emffrag.metadata.GitModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getEmfFragSourceRepository() {
		return emfFragSourceRepositoryEClass;
	}
	...
	public void createPackageContents() {
		...
		emfFragSourceRepositoryEClass = createEClass(EMF_FRAG_SOURCE_REPOSITORY);
	...
	public void initializePackageContents() {
		...
		g1.getETypeArguments().add(g2);
		emfFragSourceRepositoryEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(this.getSourceRepository());
		emfFragSourceRepositoryEClass.getEGenericSuperTypes().add(g1);
		...
		EOperation op = addEOperation(sourceRepositoryEClass, this.getCommit(), "getCommit", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(sourceRepositoryEClass, null, "putCommit", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getCommit(), "commit", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(emfFragSourceRepositoryEClass, EmfFragSourceRepository.class, "EmfFragSourceRepository", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
