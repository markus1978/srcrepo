...
bar_data <- cbind(rbind(import_data$X3_checkoutTimeSum,import_data$X4_refreshTimeSum, import_data$X5_importTimeSum, import_data$X6_writeTimeSum/1000, 0),rbind(0,0,0,0,import_data$X8_traverseTimeSum/1000))
