...
/**
 * This is the item provider adapter for a {@link de.hub.srcrepo.gitmodel.Diff} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiffItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diff_newPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diff_newPath_feature", "_UI_Diff_type"),
				 GitModelPackage.Literals.DIFF__NEW_PATH,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diff_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diff_type_feature", "_UI_Diff_type"),
				 GitModelPackage.Literals.DIFF__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOldPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diff_oldPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diff_oldPath_feature", "_UI_Diff_type"),
				 GitModelPackage.Literals.DIFF__OLD_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GitModelPackage.Literals.DIFF__FILE);
		}
	...
	public String getText(Object object) {
		String label = ((Diff)object).getNewPath();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GitModelPackage.Literals.DIFF__FILE,
				 GitModelFactory.eINSTANCE.createJavaCompilationUnitRef()));
	}
