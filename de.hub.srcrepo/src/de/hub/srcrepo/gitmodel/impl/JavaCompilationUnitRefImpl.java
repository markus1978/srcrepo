 ...
 * <ul>
 *   <li>{@link de.hub.srcrepo.gitmodel.impl.JavaCompilationUnitRefImpl#getCompilationUnit <em>Compilation Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavaCompilationUnitRefImpl extends AbstractFileRefImpl implements JavaCompilationUnitRef {
		...
		if (compilationUnit != null && compilationUnit.eIsProxy()) {
			...
			if (compilationUnit != oldCompilationUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GitModelPackage.JAVA_COMPILATION_UNIT_REF__COMPILATION_UNIT, oldCompilationUnit, compilationUnit));
			}
		}
	...
	public void setCompilationUnit(CompilationUnit newCompilationUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GitModelPackage.JAVA_COMPILATION_UNIT_REF__COMPILATION_UNIT, oldCompilationUnit, compilationUnit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GitModelPackage.JAVA_COMPILATION_UNIT_REF__COMPILATION_UNIT:
