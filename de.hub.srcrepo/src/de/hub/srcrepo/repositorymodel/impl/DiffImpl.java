 ...
 * <ul>
 *   <li>{@link de.hub.srcrepo.repositorymodel.impl.DiffImpl#getNewPath <em>New Path</em>}</li>
 *   <li>{@link de.hub.srcrepo.repositorymodel.impl.DiffImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.hub.srcrepo.repositorymodel.impl.DiffImpl#getOldPath <em>Old Path</em>}</li>
 *   <li>{@link de.hub.srcrepo.repositorymodel.impl.DiffImpl#getFile <em>File</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DiffImpl extends EObjectImpl implements Diff {
	...
	public void setNewPath(String newNewPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryModelPackage.DIFF__NEW_PATH, oldNewPath, newPath));
	}
	...
	public void setType(ChangeType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryModelPackage.DIFF__TYPE, oldType, type));
	}
	...
	public void setOldPath(String newOldPath) {
		...
		oldPath = newOldPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryModelPackage.DIFF__OLD_PATH, oldOldPath, oldPath));
	}
	...
	public NotificationChain basicSetFile(AbstractFileRef newFile, NotificationChain msgs) {
		...
		file = newFile;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RepositoryModelPackage.DIFF__FILE, oldFile, newFile);
	...
	public void setFile(AbstractFileRef newFile) {
		if (newFile != file) {
			...
			if (file != null)
				msgs = ((InternalEObject)file).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RepositoryModelPackage.DIFF__FILE, null, msgs);
			if (newFile != null)
				msgs = ((InternalEObject)newFile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RepositoryModelPackage.DIFF__FILE, null, msgs);
			msgs = basicSetFile(newFile, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryModelPackage.DIFF__FILE, newFile, newFile));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RepositoryModelPackage.DIFF__FILE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RepositoryModelPackage.DIFF__NEW_PATH:
				return getNewPath();
			case RepositoryModelPackage.DIFF__TYPE:
				return getType();
			case RepositoryModelPackage.DIFF__OLD_PATH:
				return getOldPath();
			case RepositoryModelPackage.DIFF__FILE:
				return getFile();
		}
