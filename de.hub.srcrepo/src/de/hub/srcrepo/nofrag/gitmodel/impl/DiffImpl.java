 ...
 * <ul>
 *   <li>{@link de.hub.srcrepo.nofrag.gitmodel.impl.DiffImpl#getNewPath <em>New Path</em>}</li>
 *   <li>{@link de.hub.srcrepo.nofrag.gitmodel.impl.DiffImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.hub.srcrepo.nofrag.gitmodel.impl.DiffImpl#getCompilationUnit <em>Compilation Unit</em>}</li>
 *   <li>{@link de.hub.srcrepo.nofrag.gitmodel.impl.DiffImpl#getOldPath <em>Old Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DiffImpl extends EObjectImpl implements Diff {
	 ...
	 * @ordered
	 */
	protected EObject compilationUnit;
	 ...
	 * @generated
	 */
	public EObject getCompilationUnit() {
		if (compilationUnit != null && compilationUnit.eIsProxy()) {
			InternalEObject oldCompilationUnit = (InternalEObject)compilationUnit;
			compilationUnit = eResolveProxy(oldCompilationUnit);
			if (compilationUnit != oldCompilationUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GitModelPackage.DIFF__COMPILATION_UNIT, oldCompilationUnit, compilationUnit));
			}
		}
	 ...
	 * @generated
	 */
	public EObject basicGetCompilationUnit() {
		return compilationUnit;
	}
	 ...
	 * @generated
	 */
	public void setCompilationUnit(EObject newCompilationUnit) {
		EObject oldCompilationUnit = compilationUnit;
		compilationUnit = newCompilationUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GitModelPackage.DIFF__COMPILATION_UNIT, oldCompilationUnit, compilationUnit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GitModelPackage.DIFF__TYPE:
				return getType();
			case GitModelPackage.DIFF__COMPILATION_UNIT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case GitModelPackage.DIFF__TYPE:
				...
				return;
			case GitModelPackage.DIFF__COMPILATION_UNIT:
				setCompilationUnit((EObject)newValue);
				return;
			case GitModelPackage.DIFF__OLD_PATH:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case GitModelPackage.DIFF__TYPE:
				...
				return;
			case GitModelPackage.DIFF__COMPILATION_UNIT:
				setCompilationUnit((EObject)null);
				return;
			case GitModelPackage.DIFF__OLD_PATH:
